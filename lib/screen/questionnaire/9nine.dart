import 'dart:ui';
import 'package:doglovers/screen/questionnaire/10ten.dart';
import 'package:flutter/material.dart';
import 'package:percent_indicator/linear_percent_indicator.dart';
import 'package:google_fonts/google_fonts.dart';
class nine extends StatefulWidget {
  List<String> result;
  nine({Key? key,required this.result}) : super(key: key);
                ...
                children: [
                  ...
                  Center(
                    child: Container(
                      width: 362,
                      child: Text(
                        "9) คุณอยากให้สุนัขของคุณมีความขี้เล่นระดับไหน",
                      ...
                      InkWell(
                          onTap: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => ten(result: result)),
                            );
                          },
                          child: Container(
