...
class Lab extends StatelessWidget {
  final labpics = ['images/Dogdetail/lab1.png', 'images/Dogdetail/lab2.png'];
  ...
  Center slider() {
    return Center(
      ...
      itemCount: labpics.length,
      itemBuilder: (context, index, realindex) {
        final labpic = labpics[index];

        return buildImage(labpic, index);
      },
    ));
  }

  Widget buildImage(String labpic, int index) => Container(
        ...
        Row(
          children: [
            ...
            IconButton(
              ...
              onPressed: () async {
                const url = 'https://www.facebook.com/progress.labrador.7';
        ...
        Row(
          children: [
            ...
            IconButton(
              ...
              onPressed: () async {
                const url = 'https://www.facebook.com/EJhomekennel/';
                if (await canLaunch(url)) {
                  await launch(url);
                } else {
                  throw 'Could not launch $url';
